...
# IP camera
video = 'rtsp://prawee:1q2w3e4r@10.88.97.100:554/cam/realmonitor?channel=8&subtype=0'
# Webcam
# video = 0
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            while True:
                ...
                cv2.putText(frame, "Close: Q Back Stair", (10, 40),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 3)
                cv2.putText(frame, "Close: Q Back Stair", (10, 40),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
